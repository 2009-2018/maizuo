        ...
        <nav id="toolbar" class="notybar-upside" >
          <h1>
            <a href="javascript: void 0;">
              <div class="toolbar-title-icon" @click="showNav" v-if="!flag">
                <span>
                <i class="fa fa-bars" aria-hidden="true"></i>
                </span>

              </div>
              <div class="toolbar-title-icon" v-if="flag" @click="back">
          ...
          <div id="nav-right">
            <a class="city" @click="go('map')">
              <span class="city-content">{{map}}</span>
              <span> </span>
...
<keep-alive exclude="Detail,Card,Cinema,Login,Home">
